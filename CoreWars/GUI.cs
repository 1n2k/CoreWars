            ...
            public void playerDied(object sender, Engine.Simulator.ObjectDiedEventArgs<Engine.Simulator.Player> e)
            {
                ...
                if (e.Object.Name.ToLower().StartsWith("spieler"))
                {
                    if (!Engine.Simulator.Settings.Tan)
                        ...
                        MessageBox.Show("Poor fish " + e.Object.Name.Substring(7, e.Object.Name.Length - 7) + " died.", "Sniff. A fish died.", MessageBoxButtons.OK);
                }
                else
                {
                    if (!Engine.Simulator.Settings.Tan)
                        ...
                        MessageBox.Show("Poor fish " + e.Object.Name + " died.", "Sniff. A fish died.", MessageBoxButtons.OK);
                }
                ...
                if (alivePlayers.Count == 1)
                {
                    ...
                    {
                        if (!Engine.Simulator.Settings.Tan)
                            MessageBox.Show("Der Spieler " + players[alivePlayers[0]].Name.Substring(7, players[alivePlayers[0]].Name.Length) +
                                " hat gewonnen.", "Spieler hat gewonnen", MessageBoxButtons.OK);
                        else
                            MessageBox.Show("Yay fish " + players[alivePlayers[0]].Name.Substring(7, players[alivePlayers[0]].Name.Length) +
                                " survived.", "Game's over", MessageBoxButtons.OK);
                    }
                    else
                    {
                        if (!Engine.Simulator.Settings.Tan)
                            ...
                            MessageBox.Show("Yay fish " + players[alivePlayers[0]].Name + " survived.", "Game's over", MessageBoxButtons.OK);
                    }
                    startGameButton.Enabled = true;
                    stopGameButton.Enabled = false;
                    singleStepButton.Enabled = false;
            ...
            private void startGameButton_Click(object sender, EventArgs e) //Spiel starten
            {
                if (players.Count == 0)
                {
                    if (!Engine.Simulator.Settings.Tan)
                        ...
                        MessageBox.Show("I could look at the empty sea forever...", "Sea's empty!", MessageBoxButtons.OK);
                ...
                else if (players.Count == 1)
                {
                    if (!Engine.Simulator.Settings.Tan)
                        ...
                        MessageBox.Show("Hey! Don't try to bore my dear friend!", "Fishie's lonely!", MessageBoxButtons.OK);
                }
                else
                {
                    try
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (!Engine.Simulator.Settings.Tan)
                                ...
                                MessageBox.Show("They keep swimming forever...", "A Tie...", MessageBoxButtons.OK);
                        }
                    }
                    catch (Exception) { }
                }
