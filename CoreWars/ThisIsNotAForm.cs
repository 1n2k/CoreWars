...
namespace CoreWars
{
    public partial class ThisIsNotAForm : Form
    {
        ...
        public ThisIsNotAForm(GUI.GUI _GUI)
        {
            InitializeComponent();
            myGUI = _GUI;
            myGUI.DrawRectangle += new GUI.GUI.DrawRectangleEventHandler(myGUI_DrawRectangle);
        ...
        void myGUI_DrawRectangle(object sender, GUI.GUI.DrawRectangleEventArgs e)
        {
